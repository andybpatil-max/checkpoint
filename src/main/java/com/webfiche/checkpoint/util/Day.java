...
/**
 * Stores dates and perform date arithmetic. This is another date class, but
 * more convenient than <tt>java.util.Date</tt> or <tt>java.util.Calendar</tt>
 * 
...
public class Day implements Cloneable, Serializable {
	 ...
	 * @param yyyy	year (full year, e.g., 1996, <i>not</i> starting from 1900)
	 * @param m		month
	 * @param d		day
	...
	/**
	 * Advances this day by n days. For example. d.advance(30) adds thirty days
	 * to d 
	...
	/**
	 * Converts a Julian day to a calendar date This algorithm is from Press et
	 * al., Numerical Recipes in C, 2nd ed., Cambridge University Press 1992
	 * @param j
	 *            the Julian date
	 */
