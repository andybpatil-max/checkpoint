...
public class viewStatsDb {
	...
	public int getLoadStats(Connection connection, LoadstatsSelector statSelector) {
		...
		statsSql.append("STAT_FIELD8, STAT_FIELD9, STAT_FIELD10, STAT_FIELD11, ");
		statsSql.append("STAT_FIELD12, STAT_FIELD13, STAT_FIELD14, STAT_FIELD15 ");
