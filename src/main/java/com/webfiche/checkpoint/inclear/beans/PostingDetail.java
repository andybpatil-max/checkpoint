...
/*
	@author Andy Patil
	@version $Revision: 1.1 $ $Date: 2016/03/03 23:07:43 $
*/
public final class PostingDetail implements Serializable {
	/**
	 */
	...
	private String	postingTranRefNum		= "";			// 16 "BATCH"+"nnnn" + "nnnnnnn"
