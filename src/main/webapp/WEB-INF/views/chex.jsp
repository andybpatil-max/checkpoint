...
<%--
	<tr>
		...
		<font size=3 color=blue>
			<stripes:label for="check"/> <stripes:label for="maint"/>
...
<%--
	...
	<c:forEach items="${chexSelector.checkrows}" var="ChexDetail" varStatus="idx0" 
	   end="${chexSelector.rowEnd}" begin="${chexSelector.rowStart}">
	<c:forEach items="${myProds.productrows}" var="ProductDetail" varStatus="idx0" 
	   end="${myProds.lastFunc}" begin="${myProds.offSet0}">
--%>
	  <tr>
	...
	--%>
	    ...
	    <td align="center" width='10%' height='19'>
		<stripes:link href="/econtroller/inclear/actions/Chex.action" event="Modify">
			Modify
...
<%--
	    	<c:if test="${ChexDetail.chex_check_status!='Z'}">
		<stripes:link href="/econtroller/inclear/actions/Chex.action" event="Modify">
			Modify
			    <stripes:param name="proc_date" value="${ChexDetail.chex_proc_date}"/>
			    <stripes:param name="account_number" value="${ChexDetail.chex_account_num}"/>
