...
<%--
	...
	*****************************************************************************************************
--%>
    <h1><stripes:label for="user"/> <stripes:label for="folders"/> <stripes:label for="inquiry"/></h1>
    <div id="detail">
    <table align="center" border="1" height="3" width="55%">
	<tr bgcolor=turquoise>
	    <th class="header" align=center height="19" colspan="3">
		<font size="3">
		    <stripes:label for="user"/> <stripes:label for="folder"/> 
...
<%--
	<tr>
		<th align=center height="19" colspan="1">
			<font size="3"><stripes:label for="folder.name"/></font></TH>
		<td>
...
<c:if test='${folderSelector.actionFlag!=""}'>
      <p></p>
     <center>
	<stripes:submit name="ViewAudit" value="View Audit"/>
    </center>
<br/>
...
<table class="sortable" colspan='11' width='90%' align='center' border='1' bgcolor=lightgreen height='39'>
	<tr>
	    ...
	    <th align='left' width='4%' height=15 colspan='1'>
		<font size=2><stripes:label for="date"/> <stripes:label for="modified"/></font>
	    </th>
	    <th align='left' width='4%' height=15 colspan='1'>
		<font size=2>
		    <stripes:label for="modified"/> By <stripes:label for="user"/>
...
<c:forEach items="${folderSelector.folderRows}" var="fRows" varStatus="idx0">
	...
	<td align="left" bgcolor='lightyellow' width='4%' height='19' colspan='1'>
	    <c:out value="${fRows.folderModFunc}"/>
	</td>
	<td align="left" bgcolor='lightyellow' width='4%' height='19' colspan='1'>
	    <c:out value="${fRows.folderModTime}"/>
	</td>
	<td align="left" bgcolor='lightyellow' width='4%' height='19' colspan='1'>
	    <c:out value="${fRows.folderModUser}"/>
	</td>
    </tr>
</c:forEach>
</table>
