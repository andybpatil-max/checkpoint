...
--%>
	    ...
	    <h1>
		<stripes:label for="deposit"/> <stripes:label for="histInq"/>
	    </h1>
	<div id="detail">
	    <table colspan='2' width='70%' align='center' border='1'>
			...
			<th class='header' colspan=2>
				...
				<stripes:label for="deposit"/> <stripes:label for="histdetails"/>
			    </font>
			</th>
		    </tr>
<%-- 	************	--%>
...
<%----%>
			...
			<td align='left' width='20%' height='19'>
			    ...
			    <c:if test='${depsSelector.actionFlag!="Modify"}'>
				<stripes:text name="depsDetail.chex_check_num"
					value="${depsDetail.chex_check_num}" size='12' readonly='true'/>
			    </c:if>
			</td>
		    </tr>
<%--
