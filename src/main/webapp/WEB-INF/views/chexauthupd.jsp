...
<%--													--%>
     ...
     <center>
	<stripes:errors />
	<c:if test='${chexSelector.actionFlag=="Authchex"}'>
	    <stripes:submit  name='AuthRejCheckConfirm' value="Confirm Authorize Check"/>
	</c:if>
	<c:if test='${chexSelector.actionFlag=="Rejchex"}'>
	    <stripes:submit  name='AuthRejCheckConfirm' value="Confirm Reject Check"/>
	</c:if>
	<stripes:submit  name="Authorize"  value="Cancel"/>
    </center>
