...
<%--
	...
	*****************************************************************************************************
--%>
    <h1>User <stripes:label for="contentAccess"/>
    	<c:out value=" for "/>
...
--%>
	    ...
	    <th>
		<font size=2><stripes:label for="index"/> <stripes:label for="access"/></font>
	    </th>
	    <th>
...
--%>
	...
	<td>
		...
		event="ViewFile">
		<c:out value="${FDetail.fileInFolder}"/> 
		<stripes:param name="fdir" value="${folderSelector.fileFolder}"/>
		<stripes:param name="ffile" value="${FDetail.fileInFolder}"/>
		<stripes:param name="findx" value="${FDetail.folderIndexed}"/>
	    </stripes:link>
	</td>
	<td>
	    <stripes:link href="/econtroller/infopoint/actions/ContentNavigation.action" 
