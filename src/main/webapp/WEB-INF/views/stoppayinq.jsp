...
<%--
<c:out value="${stopSelector.rowStart}"/>
<c:out value="${stopSelector.rowEnd}"/>
<c:out value="${stopSelector.rowsDisplayed}"/>
...
<div id="selres">
<table class="sortable"	colspan='8'  width='90%' align='center' border='1' cellspacing="1" cellpadding="1">
	<tr>
...
<c:forEach items="${stopSelector.stoppayrows}" var="StoppayDetail" varStatus="idx0" 
  ...
  <tr>
    ...
    <td style="text-align:right" width='10%' height='19'>
	<b><fmt:formatNumber value="${StoppayDetail.stopay_check_amount}" type="currency"/></b>
    </td>
    <td  align='center' width='10%' height='19'>
